    ...
    <footer class="kilimanjaro_area">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div class="kilimanjaro_part m-top-15">
                            ...
                            <ul class="kilimanjaro_links">
                                <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Aviso legal</a></li>
                                <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Condiciones generales</a></li>
                                <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Política de privacidad</a></li>
                                <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Política de cookies</a></li>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="kilimanjaro_part">
                            ...
                            <div class="kilimanjaro_blog_area">
                                ...
                                <p class="kilimanjaro_date">21 Jan <?php echo date('Y')?></p>
        ...
        <div class=" kilimanjaro_bottom_header_one section_padding_50 text-center">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p> &copy; <?php echo date('Y')?> Todos los derechos reservados por <a href="#">Hipnos Bed<i class="fa fa-love"></i></a></p>
                    </div>
                </div>
            </div>
        </div>
