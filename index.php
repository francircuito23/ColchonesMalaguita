...
//requires para insertar usuarios de google (migro la función)


//login normal
include('loginUsus/login.php');
...
if (isset($_GET["code"])) {
    ...
    if (!isset($token['error'])) {
        ...
        // echo $Insertar -> insertarGoogle(array(
...
// debug_to_console( $_SESSION['user_first_name'] );
...
<body>
    <div class="container">
        <br />
        <h2 style="text-align: center;"> Inicio de sesión con <img src="img/logoGoogle.png"></h2>
        <br />
        <div style="width: 130%; position: relative; margin-left: -160px">
